...
# Create screen_btn_l
screen_btn_l = lv.btn(screen)
screen_btn_l_label = lv.label(screen_btn_l)
screen_btn_l_label.set_text("Button")
screen_btn_l_label.set_long_mode(lv.label.LONG.WRAP)
screen_btn_l_label.set_width(lv.pct(100))
screen_btn_l_label.align(lv.ALIGN.CENTER, 0, 0)
screen_btn_l.set_style_pad_all(0, lv.STATE.DEFAULT)
screen_btn_l.set_pos(127, 32)
screen_btn_l.set_size(100, 50)
screen_btn_l.add_flag(lv.obj.FLAG.HIDDEN)
# Set style for screen_btn_l, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
screen_btn_l.set_style_bg_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_l.set_style_bg_color(lv.color_hex(0x2195f6), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_l.set_style_bg_grad_dir(lv.GRAD_DIR.NONE, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_l.set_style_border_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_l.set_style_radius(5, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_l.set_style_shadow_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_l.set_style_text_color(lv.color_hex(0xffffff), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_l.set_style_text_font(test_font("montserratMedium", 16), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_l.set_style_text_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_l.set_style_text_align(lv.TEXT_ALIGN.CENTER, lv.PART.MAIN|lv.STATE.DEFAULT)

# Create screen_btn_r
screen_btn_r = lv.btn(screen)
screen_btn_r_label = lv.label(screen_btn_r)
screen_btn_r_label.set_text("Button")
screen_btn_r_label.set_long_mode(lv.label.LONG.WRAP)
screen_btn_r_label.set_width(lv.pct(100))
screen_btn_r_label.align(lv.ALIGN.CENTER, 0, 0)
screen_btn_r.set_style_pad_all(0, lv.STATE.DEFAULT)
screen_btn_r.set_pos(127, 141)
screen_btn_r.set_size(100, 50)
screen_btn_r.add_flag(lv.obj.FLAG.HIDDEN)
# Set style for screen_btn_r, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
screen_btn_r.set_style_bg_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_r.set_style_bg_color(lv.color_hex(0x2195f6), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_r.set_style_bg_grad_dir(lv.GRAD_DIR.NONE, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_r.set_style_border_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_r.set_style_radius(5, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_r.set_style_shadow_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_r.set_style_text_color(lv.color_hex(0xffffff), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_r.set_style_text_font(test_font("montserratMedium", 16), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_r.set_style_text_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_btn_r.set_style_text_align(lv.TEXT_ALIGN.CENTER, lv.PART.MAIN|lv.STATE.DEFAULT)

# Create screen_label_1
screen_label_1 = lv.label(screen)
screen_label_1.set_text("08:00:00")
screen_label_1.set_long_mode(lv.label.LONG.WRAP)
screen_label_1.set_width(lv.pct(100))
screen_label_1.set_pos(42.5, 104)
screen_label_1.set_size(155, 68)
...
screen_label_1.set_style_text_font(test_font("montserratMedium", 24), lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_img_2.set_src("B:MicroPython/_humi_alpha_20x20.bin")
screen_img_2.add_flag(lv.obj.FLAG.CLICKABLE)
screen_img_2.set_pivot(50,50)
screen_img_2.set_angle(0)
screen_img_2.set_pos(2, 214)
screen_img_2.set_size(20, 20)
...
screen_img_2.set_style_radius(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_img_2.set_style_clip_corner(True, lv.PART.MAIN|lv.STATE.DEFAULT)

# Create screen_label_2
screen_label_2 = lv.label(screen)
screen_label_2.set_text("0.0")
screen_label_2.set_long_mode(lv.label.LONG.WRAP)
screen_label_2.set_width(lv.pct(100))
screen_label_2.set_pos(22, 186)
screen_label_2.set_size(93, 20)
...
screen_label_2.set_style_text_align(lv.TEXT_ALIGN.LEFT, lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_label_3.set_text("0.0")
screen_label_3.set_long_mode(lv.label.LONG.WRAP)
screen_label_3.set_width(lv.pct(100))
screen_label_3.set_pos(22, 216)
screen_label_3.set_size(93, 20)
...
screen_label_3.set_style_text_align(lv.TEXT_ALIGN.LEFT, lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_img_3.set_src("B:MicroPython/_taiyang_alpha_20x20.bin")
screen_img_3.add_flag(lv.obj.FLAG.CLICKABLE)
screen_img_3.set_pivot(50,50)
screen_img_3.set_angle(0)
screen_img_3.set_pos(2, 155)
screen_img_3.set_size(20, 20)
...
screen_img_3.set_style_radius(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_img_3.set_style_clip_corner(True, lv.PART.MAIN|lv.STATE.DEFAULT)

# Create screen_label_4
screen_label_4 = lv.label(screen)
screen_label_4.set_text("0.0")
screen_label_4.set_long_mode(lv.label.LONG.WRAP)
screen_label_4.set_width(lv.pct(100))
screen_label_4.set_pos(22, 157)
screen_label_4.set_size(93, 20)
...
screen_label_4.set_style_text_font(test_font("montserratMedium", 16), lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_label_4.set_style_text_align(lv.TEXT_ALIGN.LEFT, lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_label_5.set_style_text_font(test_font("montserratMedium", 16), lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_1_label_2.set_text("English\n")
screen_1_label_2.set_long_mode(lv.label.LONG.WRAP)
screen_1_label_2.set_width(lv.pct(100))
screen_1_label_2.set_pos(41, 80)
screen_1_label_2.set_size(158, 34)
...
screen_1_label_2.set_style_text_font(test_font("montserratMedium", 16), lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_1_label_3.set_text("英语\n")
screen_1_label_3.set_long_mode(lv.label.LONG.WRAP)
screen_1_label_3.set_width(lv.pct(100))
screen_1_label_3.set_pos(0, 148)
screen_1_label_3.set_size(240, 64)
...
screen_1_label_3.set_style_text_font(test_font("montserratMedium", 16), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_1_label_3.set_style_text_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_1_label_3.set_style_text_letter_space(2, lv.PART.MAIN|lv.STATE.DEFAULT)
...
def screen_btn_l_event_handler(e):
    code = e.get_code()
    if (code == lv.EVENT.CLICKED):
        pass
        lv.scr_load_anim(screen_1, lv.SCR_LOAD_ANIM.NONE, 200, 200, False)
screen_btn_l.add_event_cb(lambda e: screen_btn_l_event_handler(e), lv.EVENT.ALL, None)
